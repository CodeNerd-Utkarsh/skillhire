        ...
        <section className="text-center py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link href="/auth/signup?role=freelancer" passHref>
               <Button size="lg" variant="outline" className="rounded-full shadow-sm hover:shadow-lg transition-all duration-300 px-8 py-3 text-lg w-full sm:w-auto border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                Become a Seller
              </Button>
            </Link>
          </div>
